package com.morihacky.android.rxjava.util;
...
public class CoreTextUtils {
    ...
    public static String joinMap(String entrySeparator,
            String mapKeyValueSeperator,
        ...
        for (String key : keySet) {
            ...
            try {
                stringBuilder.append((key != null
                        ? java.net.URLEncoder.encode(key, UTF_8.name())
                        : ""));
                stringBuilder.append(mapKeyValueSeperator);
                stringBuilder.append(value != null
                        ? java.net.URLEncoder.encode(value, UTF_8.name())
                        : "");
    ...
    public static List<String> split(String separator,
            String stringThatNeedsSplitting,
            boolean keepOrder) {
        ...
        if (CoreNullnessUtils.isNotNullOrEmpty(result)
                && CoreNullnessUtils.isNullOrEmpty(result.get(0))) {
    ...
    private static StringBuilder _replaceAllTextInString(StringBuilder sourceStringBuilder,
            String from,
            String to) {
